window.NurseDashboard = ({ user, onLogout, patients, doctors }) => {
    ...
    // Manual MP3 Alert Logic (User Requested)
            ...
            if (e.key === "a") { 
                ...
                if (playPromise !== undefined) {
                    playPromise.catch(error => {
                        ...
                        alert("Audio playback failed! Please ensure 'alert.mp3.flac' is placed in the 'assets/sounds' folder of your project.");
                    });
                }
            }
            if (e.key === "z") { 
    ...
    return (
        <div className="flex h-screen bg-gray-100 overflow-hidden font-sans relative">
            ...
            {/* Audio Element for Manual Alerts */}
            <audio ref={audioRef} src="assets/sounds/alert.mp3.flac" preload="auto"></audio>
        </div>
    );
};